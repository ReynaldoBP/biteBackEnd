...
/*-------------------------------------------------------------------------------------*/
ALTER TABLE INFO_CLIENTE_INFLUENCER
ADD FOREIGN KEY FK_RESTAURANTE_ID_INFLUENCER(RESTAURANTE_ID)
REFERENCES INFO_RESTAURANTE(ID_RESTAURANTE);
/*-------------------------------------------------------------------------------------*/
...
/*-------------------------------------------------------------------------------------*/
ALTER TABLE INFO_PUBLICIDAD
ADD FOREIGN KEY FK_TIPO_COMIDA_ID_PUBLICIDAD(TIPO_COMIDA_ID)
REFERENCES ADMI_TIPO_COMIDA(ID_TIPO_COMIDA);
/*-------------------------------------------------------------------------------------*/
ALTER TABLE INFO_PUBLICIDAD
ADD FOREIGN KEY FK_CLIENTE_ID_PUBLICIDAD(CLIENTE_ID)
REFERENCES INFO_CLIENTE(ID_CLIENTE);
/*-------------------------------------------------------------------------------------*/
...
/*-------------------------------------------------------------------------------------*/
ALTER TABLE INFO_ENCUESTA
ADD FOREIGN KEY FK_RESTAURANTE_ID_ENCUESTA(RESTAURANTE_ID)
REFERENCES INFO_RESTAURANTE(ID_RESTAURANTE);
/*-------------------------------------------------------------------------------------*/
...
/*-------------------------------------------------------------------------------------*/
DROP TABLE IF EXISTS ADMI_TIPO_OPCION_RESPUESTA;
CREATE TABLE IF NOT EXISTS ADMI_TIPO_OPCION_RESPUESTA (
    ID_TIPO_OPCION_RESPUESTA INT AUTO_INCREMENT,
    DESCRIPCION VARCHAR(100),
	ESTADO VARCHAR(50) NOT NULL,
    USR_CREACION VARCHAR(255) NOT NULL,
	FE_CREACION DATE,
    USR_MODIFICACION VARCHAR(255),
    FE_MODIFICACION DATE,
    PRIMARY KEY (ID_TIPO_OPCION_RESPUESTA)
);
/*-------------------------------------------------------------------------------------*/
...
/*-------------------------------------------------------------------------------------*/
ALTER TABLE INFO_OPCION_RESPUESTA
ADD FOREIGN KEY FK_PREGUNTA_ID(PREGUNTA_ID)
REFERENCES INFO_PREGUNTA(ID_PREGUNTA);
/*-------------------------------------------------------------------------------------*/
ALTER TABLE INFO_OPCION_RESPUESTA
ADD FOREIGN KEY FK_TIPO_RESPUESTA_OPCION_ID(TIPO_RESPUESTA_OPCION_ID)
REFERENCES ADMI_TIPO_OPCION_RESPUESTA(ID_TIPO_OPCION_RESPUESTA);
/*-------------------------------------------------------------------------------------*/
...
ADD FOREIGN KEY FK_ENCUESTA_ID_CONT(ENCUESTA_ID)
REFERENCES INFO_ENCUESTA(ID_ENCUESTA);
/*-------------------------------------------------------------------------------------*/
ALTER TABLE INFO_CONTENIDO_SUBIDO
ADD FOREIGN KEY FK_CLIENTE_PUNTO_ID(CLIENTE_PUNTO_ID)
REFERENCES INFO_CLIENTE_PUNTO(ID_CLIENTE_PUNTO);
/*-------------------------------------------------------------------------------------*/
ALTER TABLE INFO_REDES_SOCIALES
ADD FOREIGN KEY FK_CONTENIDO_SUBIDO_ID(CONTENIDO_SUBIDO_ID)

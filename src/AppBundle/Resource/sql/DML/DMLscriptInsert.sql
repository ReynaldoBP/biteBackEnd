...
insert into INFO_OPCION_RESPUESTA(TIPO_RESPUESTA,DESCRIPCION,ESTADO,USR_CREACION,FE_CREACION) values('CERRADA','5 Estrellas','ACTIVO','kbaque',sysdate());
insert into INFO_OPCION_RESPUESTA(TIPO_RESPUESTA,DESCRIPCION,ESTADO,USR_CREACION,FE_CREACION) values('CERRADA','10 Estrellas','ACTIVO','kbaque',sysdate());
insert into INFO_OPCION_RESPUESTA(TIPO_RESPUESTA,DESCRIPCION,ESTADO,USR_CREACION,FE_CREACION) values('ABIERTA','Comentario','ACTIVO','kbaque',sysdate());
commit;